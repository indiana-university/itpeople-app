...
import { IEntity, IApiState, TaskErrorReducer, TaskStartReducer, defaultState } from "../types";
...
export const reducer: Reducer<IState> = (state = initialState, act) => {
  switch (act.type) {
    ...
    case SearchActionTypes.SEARCH_SIMPLE_FETCH_SUCCESS:
      ...
      // TODO: should payload be an IApiResponse?
      return { ...state, data: act.payload, loading: false };
