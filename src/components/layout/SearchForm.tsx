...
interface IProfileFormProps {
    onSubmit: typeof Search.submit
}

const SearchForm : React.SFC<IProfileFormProps & InjectedFormProps<{}, IProfileFormProps>> = 
({ onSubmit }) => {
    ...
    return (
            <Form  label="Search" labelVisibility="screen-reader-only" method="GET" onSubmit={handleSubmit}>
